...
from raisim_gym.env.env.spacebok import __SPACEBOK_RESOURCE_DIRECTORY__ as __RSCDIR__
...
parser.add_argument('--cfg', type=str, default=os.path.abspath(__RSCDIR__ + "/train_cfg.yaml"),
...
saver = ConfigurationSaver(log_dir=log_dir+'/spacebok_blind_locomotion',
                           save_items=[rsg_root+'raisim_gym/env/env/spacebok/Environment.hpp', cfg_abs_path])
